...
@section('title', 'Edit Data Jalan - Sistem Prioritas Perbaikan Jalan')
@section('page-title', 'Edit Data Jalan')
@section('page-subtitle', 'Ubah informasi data jalan yang sudah terdaftar')
    ...
    <div class="form-card">
        <div class="form-header">
            ...
            <div class="form-header-text">
                ...
                <p>Perbarui data jalan dengan informasi terbaru untuk akurasi perhitungan</p>
            </div>
        </div>
        
        <form action="{{ route('admin.jalan.update', $jalan->id) }}" method="POST" class="main-form" id="jalanForm">
            @csrf
            @method('PUT')
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('kode', $jalan->kode) }}" 
                               placeholder="Contoh: JL-001"
                               required>
                        <small class="form-text text-muted">Kode unik untuk identifikasi jalan (tidak dapat diubah setelah disimpan)</small>
                        @error('kode')
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="deskripsi" 
                                  ...
                                  rows="3" 
                                  placeholder="Deskripsikan kondisi jalan, lingkungan sekitar, dll...">{{ old('deskripsi', $jalan->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('latitude', $jalan->latitude) }}" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('longitude', $jalan->longitude) }}" 
            ...
            <div class="form-section">
                ...
                <div class="form-check">
                    <input type="checkbox" 
                           ...
                           value="1" 
                           {{ old('is_active', $jalan->is_active) ? 'checked' : '' }}>
            ...
            <div class="form-actions">
                <button type="submit" class="btn-submit">
                    <i class="fas fa-save"></i> Update Data Jalan
                </button>
...
<script>
    ...
    document.getElementById('jalanForm')?.addEventListener('submit', function(e) {
        ...
        // Optional: konfirmasi perubahan
        if (!confirm('Apakah Anda yakin dengan perubahan data ini?')) {
            e.preventDefault();
        }
    });
</script>
